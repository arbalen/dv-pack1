class BC_R700SA_Base : BoltActionRifle_ExternalMagazine_Base
{
    ...
    override void EEItemAttached( EntityAI item, string slot_name )
    {
        ...
        {
            HideUnhideSelection("muzzle", 0);
        }
        if (item.IsKindOf("BC_Pistolgrips"))
        {
            HideUnhideSelection("grip", 0);
        }
    }
...
class BC_R700SA_Grey: BC_R700SA_Base {};