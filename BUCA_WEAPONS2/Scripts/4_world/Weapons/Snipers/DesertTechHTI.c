class BC_DesertTechHTI_Base : BoltActionRifle_ExternalMagazine_Base
{
...
class BC_DesertTechHTI_Black: BC_DesertTechHTI_Base {};
class BC_DesertTechHTI_FDE: BC_DesertTechHTI_Base {};