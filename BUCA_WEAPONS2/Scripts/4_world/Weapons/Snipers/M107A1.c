class BC_BarrettM107A1_Base : RifleBoltLock_Base
{
    ...
    {
        super.EEInit();
        HideUnhideSelection("hideironsight", 1);
    ...
    override void EEItemAttached( EntityAI item, string slot_name )
    {
        ...
        {
            HideUnhideSelection("hideironsight", 0);
        }
...
class BC_BarrettM107A1_Black: BC_BarrettM107A1_Base {};