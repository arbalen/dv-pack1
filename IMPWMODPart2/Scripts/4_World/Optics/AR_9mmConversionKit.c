class IMP_ARAdapter_9mm: ItemBase {};
...
modded class PluginRecipesManagerBase
{
	override void RegisterRecipies()
	{
		...
		RegisterRecipe(new IMP_Attach9MMKit_to_MDR);
		RegisterRecipe(new IMP_Detach9MMKit_from_MDR);
	
	}
};

class IMP_Attach9MMKit_to_MDR extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Attach the 9mm Adapter";
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"IMP_ARAdapter_9mm");//you can insert multiple ingredients this way
		...
		//ingredient 2
		InsertIngredient(1,"IMP_MDR_Base");//you can insert multiple ingredients this way
		...
		AddResult("IMP_MDR_9mm_");//add results here
	...
	{
		Weapon_Base ingredient1 = Weapon_Base.Cast(ingredients[1]);
		
		if( ingredient1.IsEmpty() && ingredient1.IsChamberEmpty(0) )
		{
			return true;
		}
		return false;
...
class IMP_Detach9MMKit_from_MDR extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Detach the 9mm Adapter";
		m_IsInstaRecipe = false;//should this recipe be performed instantly without animation
		// m_AnimationLength = 20;//animation length in relative time units
		m_AnimationLength = 1;//animation length in relative time units
		m_Specialty = 0.02;// value > 0 for roughness, value < 0 for precision
		...
		//ingredient 2
		InsertIngredient(1,"IMP_MDR_9mm_Base");//you can insert multiple ingredients this way
		...
		AddResult("IMP_ARAdapter_9mm");//add results here
