class IMP_SnipeX_Alligator_Base: BoltActionRifle_ExternalMagazine_Base
{
	...
	override void OnDebugSpawn()
	{
		...
		SpawnAttachedMagazine("IMP_Mag_SnipeX_Alligator_5Rnd");
	}
};
class IMP_SnipeX_Alligator extends IMP_SnipeX_Alligator_Base {};